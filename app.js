...
const SITE = {
  ...
  homeCards: [
    { title:t("hm_c1_t"), desc:t("hm_c1_d"), linkLabel:t("hm_c1_l"), href:"passeios-rotas.html", img:"assets/passeios/tijucas6.jpg", icon:"boat", badge: t("badge_procurado") },
  ...
  pages: {
    ...
    "comer-beber": [
      { title: t("page_comer_c1_t"), desc: t("page_comer_c1_d"), linkLabel: t("btn_ver_detalhes"), href:"restaurantes.html", img:"assets/lanches/parada2.webp", icon:"fork", badge: t("badge_gastronomia") },
